...
class Ui_FormSetRowSizeBase(object):
    def setupUi(self, FormSetRowSizeBase):
        ...
        self.textLabelDataLength.setAlignment(
    ...
    def retranslateUi(self, FormSetRowSizeBase):
        ...
        FormSetRowSizeBase.setWindowTitle(
            _translate("FormSetRowSizeBase", "Adjust Row Size")
        )
        ...
        self.textLabelDataLength.setText(
            _translate("FormSetRowSizeBase", "Length: 2 (0x02)")
        )
