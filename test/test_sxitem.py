...
class TestSxItem(unittest.TestCase):
    def testSxItemCreationError(self):
        self.assertRaises(
            ...
            "13",
            "0000",
            "285F245F2212226A000424290008237C",
            "FF",
        )
...
class TestAdjustAddressLength(unittest.TestCase):
    def testAdjustAddressLength(self):
        self.assertEqual(
            FormInsertRowValue.adjustAddressLength(FormInsertRowValue, "12", "S19"),
            "0012",
        )
        self.assertEqual(
            FormInsertRowValue.adjustAddressLength(FormInsertRowValue, "1", "S19"),
            "0001",
        )
        self.assertEqual(
            FormInsertRowValue.adjustAddressLength(FormInsertRowValue, "12345", "S19"),
            "2345",
        )
        self.assertEqual(
            FormInsertRowValue.adjustAddressLength(FormInsertRowValue, "", "S19"),
            "0000",
        )
